...
const DATOS_MOCK: NodoOrg[] = [
  {
    ...
    retencion: 97,
    lideres: [
      { id: "l1", nombre: "Sara Jimenez", cargo: "Directora Ejecutiva", avatar: "SJ" },
      { id: "l2", nombre: "Marcos Torres", cargo: "Director de Operaciones", avatar: "MT" },
    ],
  },
  {
    id: "2",
    ...
    retencion: 94,
    lideres: [
      { id: "l3", nombre: "Sara Jimenez", cargo: "Jefa de Ingenieria", avatar: "SJ" },
      { id: "l4", nombre: "Marcos Torres", cargo: "VP de Estrategia Tecnica", avatar: "MT" },
    ],
  },
  {
    id: "3",
    ...
    retencion: 98,
    lideres: [
      { id: "l5", nombre: "Andrea Lopez", cargo: "Directora de Cumplimiento", avatar: "AL" },
    ],
  },
  {
    id: "4",
    ...
    retencion: 90,
    lideres: [
      { id: "l6", nombre: "Juan Donado", cargo: "Arquitecto Principal", avatar: "JD" },
    ],
  },
  {
    id: "5",
    ...
    retencion: 81,
    lideres: [
      { id: "l7", nombre: "Patricia Kaps", cargo: "Lider de Nube", avatar: "PK" },
    ],
  },
  {
    id: "6",
    ...
    retencion: 72,
    lideres: [
      { id: "l8", nombre: "Nicolas Reyes", cargo: "Lider de Operaciones de Seguridad", avatar: "NR" },
    ],
  },
];
...
export const obtenerNodoPorId = async (id: string): Promise<NodoOrg | undefined> => {
